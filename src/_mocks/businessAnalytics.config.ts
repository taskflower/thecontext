...
const config: AppConfig = {
        ...
        properties: {
          ...
          "generate-report": {
            ...
            properties: {
              ...
              recommendations:{ type: "array", items: { type: "string" }, title: "Rekomendacje" }
            }
          },
          "marketing-data": {
            type: "object",
          ...
          "marketing-analysis": {
            ...
            properties: {
              ...
              effectivenessRating:  { type: "string", title: "Ocena efektywności" },
              strengths:            { type: "array", items: { type: "string" }, title: "Mocne strony" },
              weaknesses:           { type: "array", items: { type: "string" }, title: "Słabe strony" },
              recommendations:      { type: "array", items: { type: "string" }, title: "Rekomendacje" },
              optimizationStrategy: { type: "string", title: "Strategia optymalizacji" }
            }
          }
        }
      }
  ...
  scenarios: [
      ...
      nodes: [
        ...
        },
        {
          ...
          attrs: {
            ...
            userMessage: "Na podstawie: przychody={{collect-data.revenue}}, koszty={{collect-data.cost}} oblicz ROI i zaproponuj rekomendacje.",
        ...
        },
        {
          ...
          attrs: {
            ...
            widgets: [
              ...
              { tplFile: "InfoWidget", title: "Opłacalność projektu", contextDataPath: "generate-report.profitability", variant: "warning" },
              { tplFile: "CardListWidget", title: "Rekomendacje", contextDataPath: "generate-report.recommendations" }
            ]
          }
        }
      ]
    },
    {
      ...
      icon: "trending-up",
      systemMessage: "Jesteś asystentem marketingowym, specjalizującym się w analizie kampanii.",
      nodes: [
        {
          slug: "marketing-data",
        ...
        },
        {
          ...
          attrs: {
            autoStart: true,
            includeSystemMessage: true,
            userMessage: "Na podstawie danych finansowych i marketingowych oblicz CPA, ROAS, CPC, CTR i zaproponuj strategię optymalizacji.",
        ...
        },
        {
          ...
          attrs: {
            ...
            widgets: [
              { tplFile: "TitleWidget", title: "Analiza efektywności marketingowej" },
              {
                tplFile: "StatsWidget",
              ...
              { tplFile: "InfoWidget", title: "Ocena efektywności", contextDataPath: "marketing-analysis.effectivenessRating", variant: "info" }
            ]
          }
        },
        {
          ...
          attrs: {
            ...
            widgets: [
              { tplFile: "TitleWidget", title: "Plan działania marketingowego" },
              { tplFile: "InfoWidget", title: "Strategia optymalizacji", contextDataPath: "marketing-analysis.optimizationStrategy", variant: "success" },
              { tplFile: "DataDisplay", title: "Mocne strony kampanii", dataPath: "marketing-analysis.strengths" },
              { tplFile: "DataDisplay", title: "Słabe strony kampanii", dataPath: "marketing-analysis.weaknesses" },
              { tplFile: "CardListWidget", title: "Rekomendowane działania", contextDataPath: "marketing-analysis.recommendations" }
            ]
          }
        }
      ]
