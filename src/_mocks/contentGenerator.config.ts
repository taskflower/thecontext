            ...
            properties: {
              ...
              outline: {
                ...
                properties: {
                  ...
                  sections: { type: "array", items: { type: "string" }, title: "Lista sekcji" }
                }
              },
              content: {
                type: "object",
                properties: {
                  ...
                  conclusion: { type: "string", title: "Podsumowanie artykułu" },
      ...
      nodes: [
        ...
        },
        {
          ...
          attrs: {
            autoStart: true,
            showResults: true,
            systemMessage: "Na podstawie tematu i grupy docelowej wygeneruj plan artykułu w JSON.",
            userMessage: "Przygotuj plan artykułu: temat={{article.topic}}, grupa={{article.audience}}"
          }
        },
        {
          ...
          attrs: {
            ...
            userMessage: "Napisz pełny artykuł: temat={{article.topic}}, grupa={{article.audience}}, plan={{article.outline.sections}}"
          }
        }
      ]
    }
