// src/modules/edv2/EditorControl.tsx - Floating toggle button
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-zinc-900 text-white rounded-full p-3 shadow-lg hover:bg-zinc-800 z-40"
