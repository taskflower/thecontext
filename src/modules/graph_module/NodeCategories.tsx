...
const NodeCategories: React.FC = () => {
            ...
            {incoming.length > 0 && (
              <div className="text-gray-600">
                ...
                {incoming.map((src, i) => (
                  <span
                    key={i}
                    className="inline-block bg-blue-100 px-1 rounded mr-1"
                  >
                    {src}
                  </span>
                ))}
            ...
            {outgoing.length > 0 && (
              <div className="text-gray-600">
                ...
                {outgoing.map((tgt, i) => (
                  <span
                    key={i}
                    className="inline-block bg-green-100 px-1 rounded mr-1"
                  >
                    {tgt}
                  </span>
                ))}
  ...
  return (
    <div>{categories.map((category) => renderCategoryFolder(category))}</div>
  );
};
