  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-lg border border-slate-200 shadow-sm p-8">
      <div className="flex flex-col items-center justify-center text-center min-h-[300px]">
        ...
        <button 
          onClick={() => onSubmit({})}
          className="px-4 py-2 bg-slate-800 text-white rounded-md shadow-sm font-semibold hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2"
        >
          Kontynuuj
        </button>
      </div>
