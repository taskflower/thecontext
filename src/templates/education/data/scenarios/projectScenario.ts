...
export function getProjectScenario(): Scenario {
  return {
    ...
    description: "Otrzymaj propozycję projektu edukacyjnego z wybranego przedmiotu i wskazówki do jego realizacji",
    nodes: [
      {
