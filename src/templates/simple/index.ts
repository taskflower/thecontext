...
export class SimpleTemplate extends BaseTemplate {
  ...
  getConfig(): BaseTemplateConfig {
    ...
    // Widgets - tylko prosty widget do wyświetlania kontekstu
    const widgets = [
      {
  ...
  getDefaultWorkspaceData(): BaseWorkspaceData {
    // Tworzymy dwa scenariusze, każdy z dwoma krokami (basic + form)
    ...
    const productNode: NodeData = {
      ...
      label: "Produkt",
      assistantMessage: "Jaki produkt Cię interesuje?",
      contextKey: "userProfile",
    ...
    const preferencesNode: NodeData = {
      ...
      assistantMessage: "Dziękujemy! Podaj więcej szczegółów o produkcie {{userProfile.interestedProduct}}:",
      contextKey: "userProfile",
      templateId: "form-step",
      formFields: [
    ...
    return {
      id: "simple-workspace",
      name: "Prosty Szablon",
      description: "Podstawowa przestrzeń robocza z prostym szablonem",
      scenarios: [userScenario, productScenario],
      templateSettings: {
