...
import { HardDrive, Folder, Power } from "lucide-react";
...
export const GoogleDriveIntegration = () => {
  ...
  const { driveConnected, error, connectToDrive, resourcesDirId } =
    useGoogleDrive();
        ...
        {driveConnected ? (
          <div className="space-y-4">
            ...
            <AlertTitle className="font-medium flex items-center gap-2">
                <Power className="h-4 w-4"/> Active Connection</AlertTitle>
